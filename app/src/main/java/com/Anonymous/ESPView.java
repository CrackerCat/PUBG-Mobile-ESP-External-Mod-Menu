...
public class ESPView extends View implements Runnable {
    ...
    protected void onDraw(Canvas canvas) {
        if (canvas != null && getVisibility() == VISIBLE) {
            ...
            DrawText(canvas, 255, 128, 0, 0,1.1f, formatter.format(time), (canvas.getWidth()/2), 40, 20);
			if(Loader.count)
			{
			DrawFilledRect(canvas,10,0,255,0,canvas.getWidth()/2-80,50,160,40);
			DrawFilledRect(canvas,10,0,255,0,canvas.getWidth()/2-72,50,144,40);
			DrawFilledRect(canvas,10,0,255,0,canvas.getWidth()/2-64,50,128,40);
			DrawFilledRect(canvas,10,0,255,0,canvas.getWidth()/2-60,50,120,40);
			DrawFilledRect(canvas,10,0,255,0,canvas.getWidth()/2-56,50,112,40);
			DrawFilledRect(canvas,10,0,255,0,canvas.getWidth()/2-52,50,104,40);
			DrawFilledRect(canvas,10,0,255,0,canvas.getWidth()/2-48,50,96,40);
			DrawFilledRect(canvas,10,0,255,0,canvas.getWidth()/2-44,50,88,40);
			//DrawLine(canvas,255,255,0,0,3,canvas.getWidth()/2,90,350,600);
			}
			//Loader.Init();
